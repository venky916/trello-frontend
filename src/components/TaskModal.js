      ...
      <div className="fixed top-0 bottom-0 right-0 left-0 bg-black/50 flex justify-center items-center">
        <div className="bg-white w-[50%] flex flex-col justify-start m-4 p-8 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            <label htmlFor="title" className="text-b-black font-semibold mb-2">
              Title
            </label>
            <input
              type="text"
            ...
            <label htmlFor="desc" className="text-b-black font-semibold mb-2">
              Description
            </label>
            <textarea
              id="desc"
            ...
            <label
              htmlFor="priority"
              className="text-b-black font-semibold mb-2"
            >
              Priority
            </label>
            <select
            ...
            <button
              type="submit"
              className={`bg-orange text-white py-2 rounded ${
                !loading && 'hover:bg-light-orange transition duration-300'
              }`}
              disabled={loading}
            >
              {loading ? (
